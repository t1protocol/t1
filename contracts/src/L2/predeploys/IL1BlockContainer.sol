...
interface IL1BlockContainer {
    ...
    event ImportBlock(
        bytes32 indexed blockHash, uint256 blockHeight, uint256 blockTimestamp, uint256 baseFee, bytes32 stateRoot
    );
    ...
    function importBlockHeader(bytes32 blockHash, bytes calldata blockHeaderRLP, bool updateGasPriceOracle) external;
}
