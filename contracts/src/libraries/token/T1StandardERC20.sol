...
/// @dev The reason that `T1StandardERC20` inherits `IT1ERC20Upgradeable` is because we need
...
/// `T1StandardERC20Factory` uses `Clones` to deploy the `T1StandardERC20` contract.
contract T1StandardERC20 is ERC20PermitUpgradeable, IT1ERC20Upgradeable {
    /// @inheritdoc IT1ERC20Upgradeable
