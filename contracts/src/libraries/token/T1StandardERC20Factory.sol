...
contract T1StandardERC20Factory is Ownable, IT1StandardERC20Factory {
    /// @notice The address of `T1StandardERC20` implementation.
    ...
    /// @inheritdoc IT1StandardERC20Factory
