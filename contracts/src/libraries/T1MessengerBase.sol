    ...
    IT1Messenger
{
    ...
    /// @notice The address of counterpart T1Messenger contract in L1/L2.
    ...
    /// @notice See {IT1Messenger-xDomainMessageSender}
    ...
    modifier notInExecution() {
        require(xDomainMessageSender == T1Constants.DEFAULT_XDOMAIN_MESSAGE_SENDER, "Message is already in execution");
        _;
    }
