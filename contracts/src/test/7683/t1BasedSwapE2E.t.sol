...
// import { L1_t1_7683Message } from "../src/libraries/L1_t1_7683Message.sol";
...
contract t1BasicSwapE2E is BaseTest {
    ...
    L1_t1_7683 internal destinationRouter;
    ...
    function _deployProxiedRouter(MockMailbox _mailbox, address _owner) internal returns (L1_t1_7683) {
        L1_t1_7683 implementation = new L1_t1_7683(address(_mailbox), permit2, domain);
