...
contract BaseTest is Test, DeployPermit2 {
        ...
        view
    {
        ...
        assertEq(resolvedOrder.openDeadline, _openDeadline, "resolvedOrder.openDeadline");
        assertEq(resolvedOrder.fillDeadline, _fillDeadline, "resolvedOrder.fillDeadline");
    }
