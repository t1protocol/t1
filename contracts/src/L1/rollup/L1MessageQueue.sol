...
contract L1MessageQueue is OwnableUpgradeable, IL1MessageQueue {
    ...
    /// @inheritdoc IL1MessageQueue
    function popCrossDomainMessage(uint256 _startIndex, uint256 _count, uint256 _skippedBitmap) external override {
    ...
    function resetPoppedCrossDomainMessage(uint256 _startIndex) external override {
    ...
    /// @inheritdoc IL1MessageQueue
    function finalizePoppedCrossDomainMessage(uint256 _newFinalizedQueueIndexPlusOne) external override {
    ...
    /// @inheritdoc IL1MessageQueue
    function dropCrossDomainMessage(uint256 _index) external {
