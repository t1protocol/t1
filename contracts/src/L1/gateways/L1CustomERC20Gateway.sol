...
contract L1CustomERC20Gateway is L1ERC20Gateway {
    ...
    /// @param _messenger The address of `L1T1Messenger` contract L1.
    constructor(
    ...
    function updateTokenMapping(address _l1Token, address _l2Token) external payable onlyOwner {
        ...
        IL1T1Messenger(messenger).sendMessage{ value: msg.value }(counterpart, 0, _message, 1_000_000, _msgSender());
    }
        ...
        nonReentrant
    {
        ...
        bytes memory _message =
            abi.encodeCall(IL2ERC20Gateway.finalizeDepositERC20, (_token, _l2Token, _from, _to, _amount, _data));
