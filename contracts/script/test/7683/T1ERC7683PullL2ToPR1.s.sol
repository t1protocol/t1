...
contract AliceSetupScript is Script {
    ...
    function run() external {
        ...
        ERC20 outputToken = ERC20(vm.envAddress("PR1_USDT_ADDR"));
        ...
        OrderData memory orderData = OrderData({
            ...
            destinationSettler: TypeCasts.addressToBytes32(vm.envAddress("PR1_T1_PULL_BASED_7683_PROXY_ADDR")),
...
contract SolverFillScript is Script {
    function run() external {
        ...
        ERC20(vm.envAddress("PR1_USDT_ADDR")).approve(
            address(pr1Router),
        ...
        pr1Router.fill(orderId, originData, fillerData);
...
contract SettlementScript is Script {
    function run() external {
        ...
        l2Router.verifySettlement(DESTINATION_CHAIN, 1_000_000, orderId);
