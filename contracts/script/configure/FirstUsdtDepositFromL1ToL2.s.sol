...
contract FirstUsdtDepositFromL1ToL2 is Script, DeploymentUtils {
    ...
    function run() external {
        ...
        T1StandardERC20(L1_USDT_ADDR).approve(L1_GATEWAY_ROUTER_PROXY_ADDR, 1000e6);

        IL1GatewayRouter(L1_GATEWAY_ROUTER_PROXY_ADDR).depositERC20(L1_USDT_ADDR, 1000e6, gasLimit);
